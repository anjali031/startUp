...
export class BanglesComponent implements OnInit {
  ...
  handleFileInputthree(file: FileList) {
    ...
    // tslint:disable-next-line: max-line-length
  OnSubmit(ORNAMENT_TYPE, ORNAMENT_MATERIAL, ORNAMENT_SHOPFOR, WEIGHT , ORNAMENT_BANGLE_STYLE, CAD_FILE , IMAGE_FILE_ONE, IMAGE_FILE_TWO,IMAGE_FILE_THREE){
    // tslint:disable-next-line: max-line-length
    ...
    this.userService.bangles(ORNAMENT_TYPE.value, ORNAMENT_MATERIAL.value,ORNAMENT_SHOPFOR.value ,WEIGHT.value,this.metala,this.asion, this.asan,this.themea, this.curateda , this.festia,this.bsizea, ORNAMENT_BANGLE_STYLE.value,this.center,this.stone,this.gem,this.color, this.fileToUpload, this.fileToUploadone, this.fileToUploadtwo, this.fileToUploadthree).subscribe(
      (data: any) => {
