...
export class MangalsutraupdateComponent implements OnInit {
  ...
  OnSubmit( ORNAMENT_MATERIAL, ORNAMENT_SHOPFOR, WEIGHT , CAD_FILE , IMAGE_FILE_ONE, IMAGE_FILE_TWO,IMAGE_FILE_THREE){
    ...
    this.userService.multiupdate(ORNAMENT_MATERIAL.value ,ORNAMENT_SHOPFOR.value ,WEIGHT.value,this.metala, this.asion, this.asan, this.themea, this.curateda , this.festia, this.fileToUpload, this.fileToUploadone, this.fileToUploadtwo, this.fileToUploadthree).subscribe(
      (data: any) => {
