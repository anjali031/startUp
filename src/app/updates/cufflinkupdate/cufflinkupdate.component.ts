...
@Component({
  selector: 'app-cufflinkupdate',
  templateUrl: './cufflinkupdate.component.html',
  styleUrls: ['./cufflinkupdate.component.css']
})
export class CufflinkupdateComponent implements OnInit {
