...
@Component({
  selector: 'app-braceletupdate',
  templateUrl: './braceletupdate.component.html',
  styleUrls: ['./braceletupdate.component.css']
})
export class BraceletupdateComponent implements OnInit {
  ...
  OnSubmit(ORNAMENT_MATERIAL, ORNAMENT_SHOPFOR, WEIGHT ,ORNAMENT_METAL,ORNAMENT_OCCASION, ORNAMENT_GIFT,ORNAMENT_THEME,ORNAMENT_CURATED_BY,ORNAMENT_FESTIVAL,ORNAMENT_BRACELET_SIZE,ORNAMENT_BRACELET_STYLE, CAD_FILE , IMAGE_FILE_ONE, IMAGE_FILE_TWO,IMAGE_FILE_THREE){
    // tslint:disable-next-line: max-line-length
