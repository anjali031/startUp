...
@Component({
  selector: 'app-ringupdate',
  templateUrl: './ringupdate.component.html',
  styleUrls: ['./ringupdate.component.css']
})
export class RingupdateComponent implements OnInit {
...
OnSubmit(ORNAMENT_MATERIAL, ORNAMENT_SHOPFOR, WEIGHT , ORNAMENT_METAL, ORNAMENT_OCCASION, ORNAMENT_GIFT, ORNAMENT_THEME, ORNAMENT_CURATED_BY, ORNAMENT_FESTIVAL, ORNAMENT_RING_SIZE, ORNAMENT_RING_STYLE, CAD_FILE , IMAGE_FILE_ONE, IMAGE_FILE_TWO, IMAGE_FILE_THREE){
    // tslint:disable-next-line: max-line-length
